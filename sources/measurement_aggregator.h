...
class MeasurementAggregator {
 public:
  ...
  void AddMeasure(i64 record) { measurements_.push_back(record); };
  ...
  void StopMeasuring() { measuring_turned_on_ = false; }

  bool ShouldMeasure() const { return measuring_turned_on_; }
